// This code was generated by `SqlHydra.Sqlite` -- v2.4.0.0.
...
type HydraReader(reader: System.Data.Common.DbDataReader) =
    ...
    let lazymainAddress = lazy (main.Readers.AddressReader(reader, buildGetOrdinal 9))
    let lazymainBuildVersion = lazy (main.Readers.BuildVersionReader(reader, buildGetOrdinal 4))
    let lazymainCustomer = lazy (main.Readers.CustomerReader(reader, buildGetOrdinal 15))
    let lazymainCustomerAddress = lazy (main.Readers.CustomerAddressReader(reader, buildGetOrdinal 5))
    let lazymainErrorLog = lazy (main.Readers.ErrorLogReader(reader, buildGetOrdinal 9))
    let lazymainProduct = lazy (main.Readers.ProductReader(reader, buildGetOrdinal 17))
    let lazymainProductCategory = lazy (main.Readers.ProductCategoryReader(reader, buildGetOrdinal 5))
    let lazymainProductDescription = lazy (main.Readers.ProductDescriptionReader(reader, buildGetOrdinal 4))
    let lazymainProductModel = lazy (main.Readers.ProductModelReader(reader, buildGetOrdinal 5))
    let lazymainProductModelProductDescription = lazy (main.Readers.ProductModelProductDescriptionReader(reader, buildGetOrdinal 5))
    let lazymainSalesOrderDetail = lazy (main.Readers.SalesOrderDetailReader(reader, buildGetOrdinal 9))
    let lazymainSalesOrderHeader = lazy (main.Readers.SalesOrderHeaderReader(reader, buildGetOrdinal 22))
    ...
    static member private GetPrimitiveReader(t: System.Type, reader: System.Data.Common.DbDataReader, isOpt: bool, isNullable: bool) =
        ...
        else if t = typedefof<System.Single> then Some(wrapValue reader.GetDouble)
        ...
        else if t = typedefof<System.Guid> then Some(wrapValue reader.GetGuid)
        else None
