// This code was generated by `SqlHydra.SqlServer` -- v1.1.0.0.
...
type HydraReader(reader: Microsoft.Data.SqlClient.SqlDataReader) =
    ...
    let lazyextDateTime2Support = lazy (ext.DateTime2SupportReader(reader, buildGetOrdinal 3))
    let lazyextGetIdGuidRepro = lazy (ext.GetIdGuidReproReader(reader, buildGetOrdinal 2))
