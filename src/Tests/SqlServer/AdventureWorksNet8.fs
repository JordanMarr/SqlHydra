...
type HydraReader(reader: Microsoft.Data.SqlClient.SqlDataReader) =
    ...
    let lazyHumanResourcesJobCandidate = lazy (HumanResources.Readers.JobCandidateReader(reader, buildGetOrdinal 3))
    let lazyHumanResourcesShift = lazy (HumanResources.Readers.ShiftReader(reader, buildGetOrdinal 5))
    let lazyPersonAddress = lazy (Person.Readers.AddressReader(reader, buildGetOrdinal 8))
    ...
    let lazyPersonPerson = lazy (Person.Readers.PersonReader(reader, buildGetOrdinal 11))
    ...
    let lazyProductionIllustration = lazy (Production.Readers.IllustrationReader(reader, buildGetOrdinal 2))
    ...
    let lazyProductionProductDocument = lazy (Production.Readers.ProductDocumentReader(reader, buildGetOrdinal 2))
    ...
    let lazyProductionProductModel = lazy (Production.Readers.ProductModelReader(reader, buildGetOrdinal 4))
    ...
    let lazySalesStore = lazy (Sales.Readers.StoreReader(reader, buildGetOrdinal 5))
    let lazydboAWBuildVersion = lazy (dbo.Readers.AWBuildVersionReader(reader, buildGetOrdinal 4))
    let lazydboDatabaseLog = lazy (dbo.Readers.DatabaseLogReader(reader, buildGetOrdinal 7))
