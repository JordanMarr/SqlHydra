// This code was generated by `SqlHydra.Oracle` -- v1.0.0.0.
namespace Oracle.AdventureWorksNet5
...
module ``C##ADVWORKS`` =
    ...
    type DIMACCOUNTReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMCURRENCYReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMCUSTOMERReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMDEPARTMENTGROUPReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMEMPLOYEEReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMGEOGRAPHYReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMORGANIZATIONReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMPRODUCTReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMPRODUCTCATEGORYReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMPRODUCTSUBCATEGORYReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMPROMOTIONReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMRESELLERReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
        member __.ADDRESSLINE1 = OptionalColumn(reader, getOrdinal, reader.GetString, "ADDRESSLINE1")
        member __.ADDRESSLINE2 = OptionalColumn(reader, getOrdinal, reader.GetString, "ADDRESSLINE2")
    ...
    type DIMSALESREASONReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMSALESTERRITORYReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMSCENARIOReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type DIMTIMEReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type FACTCURRENCYRATEReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type FACTFINANCEReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
    ...
    type FACTINTERNETSALESReader(reader: Oracle.ManagedDataAccess.Client.OracleDataReader, getOrdinal) =
