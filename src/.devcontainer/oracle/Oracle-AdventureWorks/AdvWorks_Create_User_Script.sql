...
CREATE USER c##AdvWorks IDENTIFIED BY Oracle1;

ALTER USER c##AdvWorks DEFAULT TABLESPACE USERS TEMPORARY TABLESPACE TEMP QUOTA UNLIMITED ON USERS;

GRANT CREATE SESSION TO c##AdvWorks;
