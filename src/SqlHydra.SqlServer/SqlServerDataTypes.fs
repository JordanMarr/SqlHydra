...
let supportedTypeMappings =
     ...
     * ProviderDbTypes add attributes to the generated record fields that are used by the SqlHydra.Query to specify a parameter's SqlDbType type.
     *)
    ...
    [// ColumnTypeAlias         ClrType                                     DbType                      ProviderDbTypes             ReaderMethod   
        ...
        "TIME",                 "System.TimeOnly",                          DbType.Time,                [],                         "GetTimeOnly"
#endif
        "DATETIME",             "System.DateTime",                          DbType.DateTime,            [nameof DbType.DateTime],   nameof r.GetDateTime
        "DATETIME2",            "System.DateTime",                          DbType.DateTime2,           [nameof DbType.DateTime2],  nameof r.GetDateTime
        "SMALLDATETIME",        "System.DateTime",                          DbType.DateTime,            [nameof DbType.DateTime],   nameof r.GetDateTime        
